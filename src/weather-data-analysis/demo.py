...
#
# Usage: bin/spark-submit  --conf spark.driver.host=localhost ~/Documents/meetup/demo.py ~/Downloads/weather_no_headers ~/Downloads/weather_cleaned
...
if __name__ == "__main__":
    ...
    print("Dumping Schema and Sample Data")
    df.printSchema()
    df.show()
    print(df.count())
    ...
    print("Number of entries with null Temp")
    spark.sql("""
        select count(*) 
        from weather 
        where Temp is null
    ...
    print("Average temperature per day of year:")
    avg_temp_per_day.show()
